...
class AreEnabledAdmin(admin.ModelAdmin):
    ...
    def has_add_permission(self, request):
        return not AreEnabled.objects.exists()
...
class SupportAdmin(admin.ModelAdmin):
    ...
    def get_form(self, request, obj=None, **kwargs):
        class SupportFormWithRequest(SupportForm):
            def __init__(self, *args, **form_kwargs):
                form_kwargs["request"] = request
                super().__init__(*args, **form_kwargs)

        kwargs["form"] = SupportFormWithRequest
        return super().get_form(request, obj, **kwargs)

    def has_add_permission(self, request):
        return not Support.objects.exists()
...
class AppearanceForm(forms.ModelForm):
    """
    This form integrates with the Appearance model to handle the customization of appearance-related settings, including uploading a logo file, selecting languages, and configuring positions.
    ...
    This class provides methods to clean language inputs and to save the instance with the updated logo and other configurations.
    """
...
class AppearanceAdmin(admin.ModelAdmin):
    ...
    def get_form(self, request, obj=None, **kwargs):
        class AppearanceFormWithRequest(AppearanceForm):
            def __init__(self, *args, **form_kwargs):
                form_kwargs["request"] = request
                super().__init__(*args, **form_kwargs)

        kwargs["form"] = AppearanceFormWithRequest
        return super().get_form(request, obj, **kwargs)

    def has_add_permission(self, request):
        return not Appearance.objects.exists()
...
class LLMVendorAdmin(admin.ModelAdmin):
    ...
    def get_form(self, request, obj=None, **kwargs):
        class LLMVendorFormWithRequest(LLMVendorForm):
            def __init__(self, *args, **form_kwargs):
                form_kwargs["request"] = request
                super().__init__(*args, **form_kwargs)

        kwargs["form"] = LLMVendorFormWithRequest
        return super().get_form(request, obj, **kwargs)

    def has_add_permission(self, request):
        return not LLMVendors.objects.exists()
...
class RestrictionForm(forms.ModelForm):
    """
    A Django form that dynamically configures Restriction related fields and initial data based on backend configuration.
    """
...
class RestrictionsAdmin(admin.ModelAdmin):
    ...
    def has_add_permission(self, request):
        return not Restriction.objects.exists()
...
class LLMPresetForm(forms.ModelForm):
    """
    A Django form that dynamically configures LLMPreset related fields and initial data based on backend configuration.
    """
...
class LLMPresetAdmin(admin.ModelAdmin):
    """
    Admin interface for managing the LLMPreset model.
    """
...
class AdditionalContextAdmin(admin.ModelAdmin):
    ...
    def has_add_permission(self, request):
        return not AdditionalContext.objects.exists()
