...
export default function ModelForm({
  modelId, modelName, formState, updateFormState, setIsLoadingModel,
}) {
  ...
  const handleInputChange = useCallback((event) => {
    ...
    updateFormState({ formData: { ...formData, credentials: { ...formData.credentials, [name]: value } } });
  }, [formData, updateFormState]);

  useEffect(() => {
    setIsLoadingModel(isLoading);
  }, [isLoading, setIsLoadingModel]);
