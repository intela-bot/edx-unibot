...
from uni_bot.enums import BotReadinessStatus, BotStatus, UnibotInstructorWidgetDisplayingMode
...
def zip_directory_content(
    ...
    for directory_name in directory_names:
        ...
        zip_directory_content(subdirectory_path, zip_file, base_archive_path=subdirectory_archive_path, storage=storage)


def create_directory_zip(directory_path: Path, storage: Storage = default_storage) -> io.BytesIO:
    """
...
def append_script_to_response_html_body(response: HttpResponse, script_content: str) -> None:
    """
